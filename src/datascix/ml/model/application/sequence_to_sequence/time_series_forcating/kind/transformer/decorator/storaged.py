from datascix.ml.model.application.sequence_to_sequence.time_series_forcating.kind.transformer.decorator.decorator import Decorator as TransformerTimeSeriesForcatingDecorator
