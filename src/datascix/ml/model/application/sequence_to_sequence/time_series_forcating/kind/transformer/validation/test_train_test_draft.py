...
from datascix.ml.model.application.sequence_to_sequence.time_series_forcating.training.sliding_window.generator import Generator
...
from datascix.ml.model.application.sequence_to_sequence.time_series_forcating.validation.kind.train_test_draft import TrainTestDraft
...
class TestTrainTestDraft:
    def test_plot_mean_euclidean_distance_plot(self):
        file_path = FilePath(
            "/data/experiements/oldest/robots/uav1/structure/mind/memory/explicit/long_term/episodic/normal/gaussianed_quaternion_kinematic_sliced_from_1_to_300000/time_position_sequence_sliced_from_1_to_300000.npz"
        )
