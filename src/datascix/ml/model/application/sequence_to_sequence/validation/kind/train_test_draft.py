...
class TrainTestDraft(Validation):
    def __init__(self, model: TimeSeries, train_set: NumpiedSet, test_set: NumpiedSet):
    ...
    def _test(self)->None:
        self._test_set_predictions = self._model.get_predictions(self._test_set_inputs)
