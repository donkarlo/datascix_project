...
class TrainTestByPeriods(Validation):
    ...
    @classmethod
    def init_from_one_split(cls, train_data: np.ndarray, test_data: np.ndarray, trainer_class:Trainer, architecture:Architecture, trainer_configs:Config, predictor_class: Predictor, sliding_window_step)->None:
        #preparing data
