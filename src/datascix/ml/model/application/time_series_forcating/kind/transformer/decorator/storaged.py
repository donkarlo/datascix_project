from datascix.ml.model.application.time_series_forcating.kind.transformer.decorator.decorator import Decorator as TransformerTimeSeriesForcatingDecorator
