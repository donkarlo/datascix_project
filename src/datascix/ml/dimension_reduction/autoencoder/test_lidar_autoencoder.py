from datascix.ml.dimension_reduction.autoencoder.autoencoder import Autoencoder
...
if __name__ == "__main__":
    ...
    # We have one delta_norm per time step (T-1) and one window per valid end index.
    ...
    if aligned_norms.shape[0] != num_windows:
        raise RuntimeError("Mismatch between number of windows and color series length.")
